...
\usepackage{amsthm} % gives proof environment: https://www.overleaf.com/learn/latex/Theorems_and_proofs
...
\usepackage[
    ...
    doi=true,
    isbn=false,
    date=year % https://tex.stackexchange.com/questions/55780/disable-month-in-biblatex-bibliography
...
\AtEveryBibitem{
    \clearfield{urlyear}
    \clearfield{urlmonth}
    \clearfield{eprint} % remove PMID % https://tex.stackexchange.com/questions/250784/removing-eprint-and-eprinttype-in-citation-notes
}
...
\usepackage[
    hidelinks,
    pdfa % Required for valid pdf/a output: https://tex.stackexchange.com/questions/431022/pdf-a-validation-problem-the-f-key-is-missing
]{hyperref}
\hypersetup{
    % colorlinks,
